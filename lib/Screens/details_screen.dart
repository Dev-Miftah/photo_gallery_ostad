  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.galleryModel.galleryName!,
          ...
          Padding(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(widget.galleryModel.imagePath!),
                  fit: BoxFit.cover,
                ),
                boxShadow: [
                  BoxShadow(
            ...
            Padding(
              ...
              child: Text(widget.galleryModel.galleryTitle!,
                style: const TextStyle(
                  fontSize: 24,
                  color: blackColors,
            ...
            Padding(
              ...
              child: Text(widget.galleryModel.galleryDescription!,
                style: const TextStyle(
                  fontSize: 15,
                  color: blackColors,
                  fontWeight: FontWeight.w400,
